...
/*################ Scroll Reveal(for latest projects heading and every slide heading &&images,etc ) ####################### */
ScrollReveal ({ 
    reset: true,
    distance: '80px',
    duration: 2000,
...
const typed = new Typed('.multiple-text', {
    strings: ['Frontend Developer!', 'JavaScript developer!', 'Cpp Programmer!'],
    typedSpeed: 50,
    backSpeed: 100,
    backDelay: 100,
    loop: true
...
btn.addEventListener('click', function(e) {
    ...
    Email.send({
        ...
        To : 'rashi3909@gmail.com',
        From : "rashi.2022ca076@mnnit.ac.in",
